...
<p align="center">
  <img src="dash-1.png" alt="Main Dashboard" width="47%" style="border-radius: 8px;">
  <img src="dash-2.png" alt="Another View" width="47%" style="border-radius: 8px; margin-left: 30px;">
</p>
